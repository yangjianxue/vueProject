...
* */
function getElementOffset(domEle){
 ...
 */
function getStyle(domEle,prop,pseudo = null){
 ...
 */
function getElementPosition(domEle){
 ...
 */
function addEvent(domEle,type,handle,captureType = false){
 ...
 */
function removeEvent(domEle,type,handle,caputurType = false){
